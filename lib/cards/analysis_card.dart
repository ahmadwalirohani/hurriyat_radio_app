...
import 'package:hurriyat_radio/models/slider_model.dart';
...
class AnalysisCard extends StatelessWidget {
  final AnalysisModel d;
  final heroTag;
  const AnalysisCard({Key? key, required this.d, required this.heroTag})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () => navigateToAnalysisDetailsScreen(context, d, heroTag),
    );
  }
}
