...
import 'package:hurriyat_radio/pages/home.dart';
import 'package:hurriyat_radio/pages/splash.dart';
        ...
        builder: (_, mode, child) {
          return MultiProvider(
            providers: [
              ...
              ChangeNotifierProvider<GalleryBloc>(
                  create: (context) => GalleryBloc()),
              ChangeNotifierProvider<CategoryTab5Bloc>(
                  create: (context) => CategoryTab5Bloc()),
