...
import 'package:hurriyat_radio/blocs/related_articles_bloc.dart';
import 'package:hurriyat_radio/cards/card3.dart';
...
class _RelatedArticlesState extends State<RelatedArticles> {
  ...
  void initState() {
    ...
    context
        .read<RelatedBloc>()
        .getData(widget.category, widget.timestamp, widget.locale);
    // });
  }
