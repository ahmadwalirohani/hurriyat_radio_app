...
import 'package:hurriyat_radio/blocs/featured_bloc.dart';
import 'package:hurriyat_radio/blocs/popular_articles_bloc.dart';
...
import 'package:hurriyat_radio/utils/app_name.dart';
import 'package:hurriyat_radio/utils/next_screen.dart';
import 'package:hurriyat_radio/widgets/drawer.dart';
import 'package:hurriyat_radio/widgets/tab_medium.dart';
...
class _ExploreState extends State<Explore>
  ...
  final List<Tab> _tabs = [
    ...
    Tab(
      text: Config().initialCategories[0].toString().tr(),
    ),
    Tab(
      text: Config().initialCategories[1].toString().tr(),
    ),
    Tab(
      text: Config().initialCategories[2].toString().tr(),
    ),
    Tab(
      text: Config().initialCategories[3].toString().tr(),
    ),
    Tab(
      text: Config().initialCategories[4].toString().tr(),
    ),
    Tab(
      text: Config().initialCategories[5].toString().tr(),
    ),
  ];
        ...
        return <Widget>[
          new SliverAppBar(
            ...
            actions: <Widget>[
              IconButton(
                icon: const Icon(
                  Icons.search, // AntDesign.search1,
                  size: 22,
                ),
                onPressed: () {
