...
import 'package:hurriyat_radio/blocs/search_bloc.dart';
import 'package:hurriyat_radio/cards/card4.dart';
import 'package:hurriyat_radio/utils/empty.dart';
import 'package:hurriyat_radio/utils/loading_cards.dart';
import 'package:hurriyat_radio/utils/snacbar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: sb.recentSearchData.isEmpty
          ? EmptyPage(
              icon: Icons.search, // Feather.search,
...
class AfterSearchUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: FutureBuilder(
        future: context.watch<SearchBloc>().getData(context.locale),
