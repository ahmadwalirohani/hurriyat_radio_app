...
class _ArticleDetailsState extends State<ArticleDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final NewsModel article = widget.data!;
  ...
  SliverAppBar _customAppBar(NewsModel article, BuildContext context) {
    return SliverAppBar(
      expandedHeight: 270,
      ...
      actions: <Widget>[
        false == null
            ...
            : IconButton(
                icon:
                    const Icon(Icons.mic_external_off, //Feather.external_link,
                        size: 22,
                        color: Colors.white),
                onPressed: () => {
