...
import 'package:hurriyat_radio/blocs/videos_bloc.dart';
import 'package:hurriyat_radio/cards/card4.dart';
import 'package:hurriyat_radio/cards/card5.dart';
  ...
  void _scrollListener() {
    ...
    if (!db.isLoading) {
      if (controller!.position.pixels == controller!.position.maxScrollExtent) {
        ...
        context.read<VideosBloc>().getData(mounted, _orderBy, false);
      }
    }
  }
