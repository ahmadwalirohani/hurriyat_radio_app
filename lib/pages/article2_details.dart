...
import 'package:hurriyat_radio/models/article_model.dart';
...
class Article2Details extends StatefulWidget {
  final ArticleModel? data;
  final String? tag;

  const Article2Details({Key? key, required this.data, required this.tag})
      : super(key: key);

  @override
  _Article2DetailsState createState() => _Article2DetailsState();
}

class _Article2DetailsState extends State<Article2Details> {
  ...
  Widget build(BuildContext context) {
    ...
    final ArticleModel article = widget.data!;
  ...
  SliverAppBar _customAppBar(ArticleModel article, BuildContext context) {
    return SliverAppBar(
